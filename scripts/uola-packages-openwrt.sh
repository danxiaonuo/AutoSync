...
curl -fsSL https://raw.githubusercontent.com/danxiaonuo/AutoSync/master/server/acl.d/luci-app-smartdns.json > xiaonuo/luci-app-smartdns/root/usr/share/rpcd/acl.d/luci-app-smartdns.json
