...
# 修改smartdns配置
curl -fsSL https://raw.githubusercontent.com/danxiaonuo/AutoSync/master/server/smartdns/newsmartdns > package/base-files/files/etc/newsmartdns
curl -fsSL https://raw.githubusercontent.com/danxiaonuo/AutoSync/master/server/smartdns/smartdns.conf > package/base-files/files/etc/smartdns.conf
